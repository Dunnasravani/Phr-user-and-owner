          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-nav-first">
                        <li><a href="PhrOwnerHome.jsp" class="smoothScroll">Home</a></li>
                        <li><a href="ViewProfileOwner.jsp" class="smoothScroll">View Profile</a></li>
                         <!--<li><a href="DataOwnerSym.jsp" class="smoothScroll">Enter Symptoms</a></li>-->
                         <li><a href="FileUpload.jsp" class="smoothScroll">File Upload</a></li>
                         <li><a href="ViewUploadedPatientData.jsp" class="smoothScroll">View Uploaded Files</a></li>
                       <!--  <li><a href="VerifyUploadedFiles" class="smoothScroll">Verify Uploaded Files</a></li>-->
...
<table>
    <%
        session.setAttribute("tokenid",request.getParameter("tid"));
        
        
        %>
        <h1>Upload the file</h1><br><br><br><br>
          <form action="Upload" method="post" enctype="multipart/form-data"> 
          <!--    <tr>
                            <td style="color: brown">Select Cloud Name:</td>
                            <td>
                                <select name="cname">
              ...
              <tr><td><label style="font-size: 20px;margin-left:30px;">File Upload:</label></td></tr>
              <tr><td><input type="file" id="id"  style="height: 40px; width:250px; " name="file" required style="margin-left: 45px;" placeholder="Enter one time key "/></td></tr>
 
                      <tr><td><input type="submit"  value="Upload"style="border-radius: 12px;height: 38px;width: 93px;background-color:#ff33ff"/></td></tr>
