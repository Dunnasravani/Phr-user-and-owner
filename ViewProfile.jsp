          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-nav-first">
                        <li><a href="PhrUserHome.jsp" class="smoothScroll">Home</a></li>
                        <li><a href="ViewProfile.jsp" class="smoothScroll">View Profile</a></li>
                         <li><a href="ViewData.jsp" class="smoothScroll">View Uploaded Files</a></li>
                         
                         <li><a href="Downloadpatient.jsp" class="smoothScroll">Download</a></li>
          ...
          <div class="container">
               <div class="row">
                   ...
                   <%
                           ...
                           //String id="1";
                       String sql="select * from datareceiver where id="+id;
                       System.out.println("Id in profile is "+sql);
