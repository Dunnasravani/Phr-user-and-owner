          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-nav-first">
                         ...
                         <li><a href="DataOwner.jsp" class="smoothScroll">DataOwner</a></li>
                         <li><a href="DataUser.jsp" class="smoothScroll">User</a></li>
     ...
     <section id="feature">
          <div class="container">
               <div class="row">
                   ...
                   <form name="f1" method="post" action="KeyServerLoginDb.jsp">
     <table align="center">
