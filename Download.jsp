               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-nav-first">
                        ...
                        <li><a href="ViewProfile.jsp" class="smoothScroll">View Profile</a></li>
                         ...
                         <li><a href="Downloadpatient.jsp" class="smoothScroll">Download PatientData</a></li>
          ...
          <div class="container">
               <div class="row">
                   ...
                   <table align="center" border="1">
                       ...
                       <form name="f1" method="get" action="downloadfile.jsp">
                           <input type="hidden" name="fid" value="<%=fid%>">
                           Enter The Key <input type="text" name="skey">
