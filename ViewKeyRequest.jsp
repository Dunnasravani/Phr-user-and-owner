          ...
          <div class="container">
               <div class="row">
                   ...
                   <%
                       ...
                       ResultSet rs=st.executeQuery("select k.id,file_name,date,name,mail from datareceiver d,files f,keyrequest k where d.id=k.datareceiver and f.id=k.fid and keyrequest='yes'");
                       ...
                       <%
                        ...
                        %>
                        <td><a href="accept.jsp?id=<%=rs.getString(1)%>">Accept</a></td></tr>
                        <%
                           }
                       %>
                    </table>
