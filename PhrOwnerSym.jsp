     ...
     <section id="feature">
          <div class="container">
               <div class="row">
                   ...
                   <form action="DataOwnerSymDB.jsp" method="post">              
                    <table>
                        <tr>
                        ...
                        <tr>
                           ...
                           <td style="color: brown">Age:</td>
                            <td>
                                <input type="text" name="age">
                            </td>
                        </tr>
                        <tr>
                            <td style="color: brown">Symptoms:</td>
                            <td>
                                <input type="text" name="sym">
                            </td>
                        </tr>
                        <tr>
                            <td style="color: brown">Disease</td>
                            <td>
                                <input type="text" name="dis">
                            </td>
                        </tr>
                        <tr>
                            <td style="color: brown">Mac Address</td>
                            <td>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <input type="submit" value="Add Symtom">
...
<center><a href="DataOwnerRegistration.jsp">NewUser</a></center>
